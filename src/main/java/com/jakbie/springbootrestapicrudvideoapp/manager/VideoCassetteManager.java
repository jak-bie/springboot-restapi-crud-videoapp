package com.jakbie.springbootrestapicrudvideoapp.manager;

import com.jakbie.springbootrestapicrudvideoapp.dao.VideoCassetteRepo;
...
public class VideoCassetteManager {
    ...
    public void fillDB() {
        save(new VideoCassette(1L,"Star Wars: Return of The Jedi",
                LocalDate.of(1983,5,25)));
        save(new VideoCassette(2L,"Star Wars: A New Hope",
